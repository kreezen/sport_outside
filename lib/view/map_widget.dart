...
import 'package:sportoutside/view/sportplace_icon_widget.dart';
import 'package:sportoutside/view/sportplace_preview_widget.dart';
...
class MapWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    sportplaces.value.maybeMap(
      orElse: () => const Text("Loading..."),
      data: (value) => markers = value
          .map((e) => Marker(
              width: 80.0,
              height: 80.0,
              point: LatLng(e.coordinates.latitude, e.coordinates.longitude),
